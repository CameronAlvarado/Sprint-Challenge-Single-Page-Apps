...
> Answer: Faster load times for the user after the initial download.
- [ ] What does AJAX stand for?
> Answer: Asynchronous Javascript and XML
- [ ] What are `controlled components` in React?
> Answer: When the componenet's data isn't effected by something like user input, value is controlled by react.
